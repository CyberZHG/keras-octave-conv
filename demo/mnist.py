...
import numpy as np
from keras.layers import Input, BatchNormalization, MaxPool2D, Dropout, Flatten, Dense
...
dropout_score = model.evaluate(x_test, y_test)
print('Accuracy: %.4f' % dropout_score[1])
